...
const RequestTypeCategoryToLabelMap: { [key in RequestTypeCategory]: string } = {
...
export type ExportList = {
    ...
    statusEvents: any; 
    displayId: any; 
    location: { address: any; latitude: any; longitude: any }; 
    createdAt: any; 
    callStartedAt: any; 
    callEndedAt: any; 
    priority: any;
...
export const MAILGUN_CREDS = {
    api_key:"55ba72f6f33f5a2a9eb5e42597915330-f8b3d330-4f97bfd8",
    domain:"mg.raheem.org"
}