...
const STRINGS = {
    ...
    REQUESTS: {
        ...
        deleteRequestOptionYes: (requestName: string) => `Remove request ${requestName}`,
        deleteRequestSuccess: (requestName: string) => `Request ${requestName} was successfully deleted.`,
