...
export default class Form extends React.Component<FormProps> {
    ...
    private isValid = computed<boolean>(() => {
        return this.validatableInputs.get().filter(i => i.required).every(i => i.isValid());
    })
