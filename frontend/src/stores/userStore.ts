...
import { AttributeHandle, AuthTokens, EditableMe, EditableUser, Me, MinUser, ProtectedUser, RequestSkill, UserRole } from '../../../common/models';
...
export default class UserStore implements IUserStore {
    ...
    async inviteUserToOrg(email: string, phone: string, roles: UserRole[], roleIds: string[], attributes: AttributeHandle[], skills: RequestSkill[], baseUrl: string) {
