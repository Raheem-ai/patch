...
export const ActiveRequestTabHeight = 112;
...
export const headerIconPaddingVertical = 16;
export const headerIconPaddingHorizontal = 24;
export const headerIconContainerSize = (2 * headerIconPaddingVertical) + headerIconSize;
